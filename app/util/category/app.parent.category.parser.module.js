...
var CategoryParesrModule = (function () {
    function CategoryParesrModule() {
    }
    CategoryParesrModule = __decorate([
        core_1.NgModule({
            imports: [],
    ...
    ], CategoryParesrModule);
    return CategoryParesrModule;
}());
exports.CategoryParesrModule = CategoryParesrModule;
