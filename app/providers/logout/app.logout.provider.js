...
var LogoutProvider = (function () {
    function LogoutProvider(http) {
        this.http = http;
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        this.serviceUrl = app_service_url_1.URL + "/user/logout";
    }
    LogoutProvider.prototype.handleError = function (error) {
...
//# sourceMappingURL=app.logout.provider.js.map