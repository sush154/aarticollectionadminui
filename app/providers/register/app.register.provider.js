...
var RegisterProvider = (function () {
    function RegisterProvider(http) {
        ...
        this.serviceUrl = app_service_url_1.URL + "/user/register";
    }
    RegisterProvider.prototype.handleError = function (error) {
    ...
    */
    RegisterProvider.prototype.register = function (registerObj) {
        var _this = this;
...
//# sourceMappingURL=app.register.provider.js.map